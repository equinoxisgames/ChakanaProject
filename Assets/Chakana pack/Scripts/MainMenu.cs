...
public class MainMenu : MonoBehaviour
{
    ...
    public void LocateMapScene()
    {
        ...
        if (escena != "00- Main Menu 0")
        {
            ...
            //Debug.Log("La posici�n de " + player.name + " es: " + position.ToString());
    ...
    public void UpdateMapSpotPosition(float x, float y, float z)
    {
        ...
        {
            // Aseg�rate de que el objeto sea de tipo Image.
            Image imagen = objetoAMover.GetComponent<Image>();

            if (imagen != null)
            {
                // Cambia la posici�n de la imagen.
        ...
        {
            Debug.LogError("No se encontr� ning�n objeto con la etiqueta especificada.");
        }
    ...
    public void Escape()
    {
        ...
        if (Input.GetButtonDown("Cancel"))
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    Debug.Log("Se ha presionado el bot�n Escape (start) del gamepad porque mouseMovido es " + mouseMovido);
                }
            }
        }
        else
        {
            if (Input.GetButtonDown("Dash"))
            {
                if (escena != "00- Main Menu 0")
                {
                    // Bot�n B del gamepad: cierra el men� de pausa si est� abierto
                    ...
                    Debug.Log("Bot�n B del gamepad: cierra el men� de pausa si est� abierto");
                }
            }
            else
